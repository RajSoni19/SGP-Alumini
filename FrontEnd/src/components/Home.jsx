                ...
                <div className="container h-100">
                    <div className="row h-100 align-items-center justify-content-center">
                        <div className="col-lg-8 text-center">
                            <h1 className="text-white font-weight-bold display-3 mb-4">Welcome to Charusat ALUMNI</h1>
                            <p className="text-white-75 font-weight-light lead mb-5">Connecting Charusat Alumni Across The Globe</p>
                            <div className="d-flex justify-content-center gap-3">
                                {!isLoggedIn && (
                                    <>
                                        <Link className="btn btn-primary btn-xl" to="about">Find Out More</Link>
                                        <Link className="btn btn-info btn-xl" to="login">Login</Link>
                                    </>
                                )}
                                {isLoggedIn && <Link className="btn btn-info btn-xl" to="account">Profile</Link>}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className={`page-section bg-${theme}`} id="alumni-benefits">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h3 className=" card-title text-muted">As a member of the global alumni network, you can enjoy a range of exclusive services and benefits.</h3>
                    </div>
                    <div className="row">
